...
_$JobImpl _$$JobImplFromJson(Map<String, dynamic> json) => _$JobImpl(
      ...
      createdByApiKeyId: json['created_by_api_key_id'] as String?,
      createdByDiscordUserId: json['created_by_discord_user_id'] as String?,
...
Map<String, dynamic> _$$JobImplToJson(_$JobImpl instance) {
  ...
  writeNotNull('created_by_api_key_id', instance.createdByApiKeyId);
  writeNotNull('created_by_discord_user_id', instance.createdByDiscordUserId);
