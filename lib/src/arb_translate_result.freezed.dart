...
abstract class $ArbTranslateResultCopyWith<$Res> {
  factory $ArbTranslateResultCopyWith(
          ArbTranslateResult value, $Res Function(ArbTranslateResult) then) =
...
abstract class _$$ArbTranslateResultImplCopyWith<$Res>
    implements $ArbTranslateResultCopyWith<$Res> {
  factory _$$ArbTranslateResultImplCopyWith(_$ArbTranslateResultImpl value,
...
class __$$ArbTranslateResultImplCopyWithImpl<$Res>
  ...
  __$$ArbTranslateResultImplCopyWithImpl(_$ArbTranslateResultImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ArbTranslateResultImpl(
      module: null == module
          ? _value.module
          : module // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$ArbTranslateResultImpl extends _ArbTranslateResult {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._localesUpdated, _localesUpdated) &&
            const DeepCollectionEquality()
                .equals(other._keysByFile, _keysByFile) &&
  ...
  Map<String, dynamic> toJson() {
    return _$$ArbTranslateResultImplToJson(
      this,
    );
  }
}
...
abstract class _ArbTranslateResult extends ArbTranslateResult {
  const factory _ArbTranslateResult(
      ...
      final int failedKeyCount,
      final List<String> warnings}) = _$ArbTranslateResultImpl;
